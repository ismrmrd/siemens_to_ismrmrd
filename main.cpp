...
int main(int argc, char *argv[] )
{
    ...
    desc.add_options()
        ...
        ("getXML_VB,M",             po::value<bool>(&download_xml_VB)->implicit_value(true), "<Get VB parameter map XML file>")
        ("getXML_VD,N",             po::value<bool>(&download_xml_VD)->implicit_value(true), "<Get VD parameter map XML file>")
    ...
    display_options.add_options()
        ...
        ("getXML_VB,M",             "<Get VB parameter map XML file>")
        ("getXML_VD,N",             "<Get VD parameter map XML file>")
